-- Remove duplicate use_ai_credit functions
-- This will drop ALL versions and create only ONE

-- =====================================================
-- Drop ALL use_ai_credit functions using CASCADE
-- =====================================================

-- This will drop all versions regardless of signature
DROP FUNCTION IF EXISTS public.use_ai_credit CASCADE;

-- =====================================================
-- Create SINGLE use_ai_credit function
-- =====================================================
...
-- Add comment
COMMENT ON FUNCTION public.use_ai_credit(UUID, TEXT, TEXT, INTEGER, TEXT, TEXT) IS 'Deducts 1 credit and saves question to history - SINGLE VERSION ONLY';

-- =====================================================
-- Verify: Should be exactly 1 use_ai_credit function
-- =====================================================
-- Run this to verify:
...
-- Expected result: use_ai_credit | 1
